...
static void rna_def_space_view3d_overlay(BlenderRNA *brna)
{
  ...
  RNA_def_property_clear_flag(prop, PROP_ANIMATABLE);
  RNA_def_property_ui_text(prop, "Bone Depth Fade", "Reduce bone wireframe opacity with depth");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, "rna_GPencil_update");
  ...
  RNA_def_property_ui_text(
      prop,
      "Depth Fade Step",
      "Depth distance step at which bone wireframe opacity fades to half of its "
      "previous value. Zero disables depth-based fade");
  RNA_def_property_update(prop, NC_SPACE | ND_SPACE_VIEW3D, "rna_GPencil_update");
